...
class MyUserModelTest(TransactionTestCase):
    def test_following(self):
        ...
        # 이후 해당 유저의 following MTM 필드에 팔로우한 유저들이 있는지 확인
        ...
        # 반대로 follower를 가진 유저는 follower_set(역참조 이름)으로
        # 자신을 follow 하는 유저를 출력하는지 검사
